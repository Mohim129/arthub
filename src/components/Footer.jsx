export default function Footer() {
  return (
    <footer className="bg-inverse-surface text-white w-full py-xl">
      <div className="max-w-[1280px] mx-auto px-gutter grid grid-cols-1 md:grid-cols-4 gap-lg">
        {/* Brand */}
        <div>
          <span className="font-h3 text-h3 font-bold text-white mb-md block">
            ArtHub
          </span>
      ...
      {/* Bottom bar */}
      <div className="max-w-[1280px] mx-auto px-gutter mt-xl pt-lg border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-md">
        <span className="text-sm text-white/60">
          © 2026 ArtHub. Elevating digital artistry.
        </span>
