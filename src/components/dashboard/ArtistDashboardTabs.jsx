        ...
        <div className="max-w-4xl mx-auto space-y-xl">
            ...
            {tab === 'sales' && (
                <section>
                    ...
                    <p className="text-on-surface-variant">Your sales history will appear here.</p>
                </section>
            )}
            {tab === 'profile' && (
                <section>
                    <h2 className="font-h2 text-h2 mb-md">Profile Settings</h2>
                    <p className="text-on-surface-variant">Update your profile details and password.</p>
                </section>
            )}
        </div>
    );
